...
<qgis version="2.18.6" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="kode_hoved" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="1" value="T31" label="T31"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="86,145,239,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="kode_hoved"/>
  ...
  <aliases>
    ...
    <alias field="5KU-AR-SG" index="21" name="Rydningsrøyser 5 KU-AR-RY"/>
    <alias field="7RA-SJ" index="22" name="Rask gjenvesktsuksesjon i semi-naturlig og sterkt endret jordbruksmark 7RA-SJ"/>
    <alias field="7SD-0" index="23" name="Skogbestandsdynamikk 7SD-0"/>
    <alias field="n2_mosai_%" index="24" name="angi prosentandel av Naturtype 2"/>
    <alias field="n2_mosaikk" index="25" name="Mosaikk"/>
    <alias field="n2_sammen" index="26" name="Sammensatt"/>
    <alias field="n2_uLKM-HI" index="27" name="HI (Hevdintensitet) Naturtype2"/>
    <alias field="n2_uLKM-SP" index="28" name="SP (Slåttemarkspreg) Naturtype2"/>
    <alias field="n2_1AG-A0" index="29" name="Total tresjiktsdekning 1AG-A-0 (A9-skala)"/>
    <alias field="n2_1AG-B" index="30" name="Busksjiktsdekning 1AG-B (A9-skala)"/>
    <alias field="n2_1AR-A" index="31" name="Relativ sammensetning av tresjiktet - 1. 1AR-A-0 (%)"/>
    <alias field="n2_1AR-Asu" index="32" name="Relativ sammensetning av tresjiktet - 1. 1AR-A-0 (treslag)"/>
    <alias field="n2_1AR-A2" index="33" name="Relativ sammensetning av tresjiktet - 2. 1AR-A-0 (%)"/>
    <alias field="n2_1AR-A2s" index="34" name="Relativ sammensetning av tresjiktet - 2. 1AR-A-0 (treslag)"/>
    <alias field="n2_5KU-AR" index="35" name="Rydningsrøyser 5 KU-AR-RY"/>
    <alias field="n2_7SD-0" index="36" name="Skogbestandsdynamikk 7SD-0"/>
    <alias field="n2_7RA-SJ" index="37" name="Rask gjenvesktsuksesjon i semi-naturlig og sterkt endret jordbruksmark 7RA-SJ"/>
    <alias field="n3_mosai_%" index="38" name="angi prosentandel av Naturtype 3"/>
    <alias field="n3_komment" index="39" name="eventuelte beskrivelsesvariabler ved Naturtype 3"/>
    <alias field="n3_uLKM_ko" index="40" name="eventuelte uLKM-er ved Naturtype 3"/>
    <alias field="H_Komment" index="41" name=""/>
    <alias field="7JB-HT-ST" index="42" name="Lauving av styvingstrær 7JB-HT-ST"/>
    <alias field="4DL-0" index="43" name="Totalantall liggende dødvedenheter 4DL-0"/>
    <alias field="Areal" index="44" name="current AREA (m^2)"/>
    <alias field="virt_id" index="45" name="current ID"/>
  </aliases>
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Naturtype 1" groupBox="0" columnCount="1">
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Beskrivelsesvariabler 1" groupBox="1" columnCount="1">
        ...
        <attributeEditorField showLabel="1" index="43" name="4DL-0"/>
        <attributeEditorField showLabel="1" index="21" name="5KU-AR-SG"/>
        <attributeEditorField showLabel="1" index="23" name="7SD-0"/>
        <attributeEditorField showLabel="1" index="22" name="7RA-SJ"/>
        <attributeEditorField showLabel="1" index="42" name="7JB-HT-ST"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Naturtype 2" groupBox="0" columnCount="1">
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Mosaikk eller sammensatt" groupBox="1" columnCount="2">
        <attributeEditorField showLabel="1" index="25" name="n2_mosaikk"/>
        <attributeEditorField showLabel="1" index="26" name="n2_sammen"/>
        <attributeEditorField showLabel="1" index="24" name="n2_mosai_%"/>
      </attributeEditorContainer>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="uLKM-er 2" groupBox="1" columnCount="1">
        <attributeEditorField showLabel="1" index="27" name="n2_uLKM-HI"/>
        <attributeEditorField showLabel="1" index="28" name="n2_uLKM-SP"/>
      </attributeEditorContainer>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Beskrivelsesvariabler 2" groupBox="1" columnCount="1">
        <attributeEditorField showLabel="1" index="29" name="n2_1AG-A0"/>
        <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name=" Relativ sammensetning av tresjiktet (A5-skala)" groupBox="1" columnCount="1">
          <attributeEditorField showLabel="1" index="31" name="n2_1AR-A"/>
          <attributeEditorField showLabel="1" index="32" name="n2_1AR-Asu"/>
          <attributeEditorField showLabel="1" index="33" name="n2_1AR-A2"/>
          <attributeEditorField showLabel="1" index="34" name="n2_1AR-A2s"/>
        </attributeEditorContainer>
        <attributeEditorField showLabel="1" index="30" name="n2_1AG-B"/>
        <attributeEditorField showLabel="1" index="35" name="n2_5KU-AR"/>
        <attributeEditorField showLabel="1" index="36" name="n2_7SD-0"/>
        <attributeEditorField showLabel="1" index="37" name="n2_7RA-SJ"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Naturtype 3" groupBox="0" columnCount="1">
      <attributeEditorField showLabel="1" index="38" name="n3_mosai_%"/>
      ...
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="uLKM-er 3" groupBox="1" columnCount="1">
        <attributeEditorField showLabel="1" index="40" name="n3_uLKM_ko"/>
      </attributeEditorContainer>
      <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Beskrivelsesvariabler 3" groupBox="1" columnCount="1">
        <attributeEditorField showLabel="1" index="39" name="n3_komment"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer showLabel="1" visibilityExpressionEnabled="0" visibilityExpression="" name="Kommentar" groupBox="0" columnCount="0">
      <attributeEditorField showLabel="1" index="-1" name="Kommentar"/>
      <attributeEditorField showLabel="1" index="45" name="virt_id"/>
      <attributeEditorField showLabel="1" index="44" name="Areal"/>
    </attributeEditorContainer>
